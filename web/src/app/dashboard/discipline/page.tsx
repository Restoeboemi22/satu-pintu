      ...
      <div className="space-y-6">
        ...
        <div className="glass-effect-dark-card rounded-3xl p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.3fr)_minmax(340px,0.9fr)]">
            <div className="rounded-3xl border border-slate-700/50 overflow-hidden">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            disabled={!canManageRules || isSavingRule}
                            className="inline-flex items-center gap-1 rounded-lg border border-slate-700 bg-slate-900/70 px-3 py-2 text-xs font-semibold text-slate-100 hover:border-blue-500/50 hover:text-blue-200 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                          ...
                          <button
                            ...
                            disabled={!canManageRules || isSavingRule}
                            className="inline-flex items-center gap-1 rounded-lg border border-slate-700 bg-slate-900/70 px-3 py-2 text-xs font-semibold text-slate-100 hover:border-amber-500/50 hover:text-amber-200 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                          ...
                          <button
                            ...
                            disabled={!canManageRules || isSavingRule}
                            className="inline-flex items-center gap-1 rounded-lg border border-slate-700 bg-slate-900/70 px-3 py-2 text-xs font-semibold text-slate-100 hover:border-red-500/50 hover:text-red-200 disabled:cursor-not-allowed disabled:opacity-50"
                          >
